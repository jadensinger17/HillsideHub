-- 021: Update behavioral interview questions in all rubric templates
-- Replaces old single "Behavioral Interview" section (b1–b9) with the full
-- Hillside GENESIS behavioral question bank organized into 8 category sections.
-- Technical sections (Conceptual/Hillside + Ekkobar case study) are preserved.
...
SET template = jsonb_set(
  ...
  '{sections}',
  (
    -- New behavioral sections prepended to existing technical sections
    '[
      {
        ...
        "fields": [
          {
            "key": "sched",
            "label": "NOTE: Confirm candidate can attend — Mon/Wed 11:00–12:15 · Thu IB Meetings 4:30–6:00 · Thu Work Sessions 5:00 PM",
            "type": "boolean"
          },
          {
            "key": "g1",
            ...
            "type": "rating",
            "max": 5,
            "hint": "Dig into specifics on resume if unclear; ask about career goals and aspirations if they don''t elaborate"
          },
          {
            "key": "g2",
            "label": "Why do you want to join Hillside?",
            "type": "rating",
            "max": 5
          }
        ]
      ...
      },
      {
        ...
        "fields": [
          {
            "key": "bal1",
            "label": "Where would Hillside fall on your priority list, and what are your major priorities?",
            "type": "rating",
            "max": 5,
            "hint": "If they immediately say Hillside is first, follow up: ''How many hours a week do you expect to dedicate to Hillside?''"
          },
